/*	$NetBSD: nouveau_nvkm_engine_disp_hdmi.c,v 1.2 2021/12/18 23:45:35 riastradh Exp $	*/

// SPDX-License-Identifier: MIT
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: nouveau_nvkm_engine_disp_hdmi.c,v 1.2 2021/12/18 23:45:35 riastradh Exp $");
