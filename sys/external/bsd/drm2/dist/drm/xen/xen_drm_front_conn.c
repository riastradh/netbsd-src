/*	$NetBSD: xen_drm_front_conn.c,v 1.2 2021/12/18 23:45:45 riastradh Exp $	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "$NetBSD: xen_drm_front_conn.c,v 1.2 2021/12/18 23:45:45 riastradh Exp $");
